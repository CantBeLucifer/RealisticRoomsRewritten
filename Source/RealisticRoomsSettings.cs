...
namespace RealisticRoomsRewritten
{
    ...
    public class RealisticRoomsMod : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect canvas)
        {
            ...
            ls.End();
            ls.Begin(rect.BottomPart(0.6f));
            ls.ColumnWidth = canvas.width;
            ls.GapLine();
            Text.Anchor = (TextAnchor)3;
            Text.Font = GameFont.Medium;
            ls.Label("SettingsExtraTweaksLabel".Translate());
            ls.ColumnWidth = 20f;
            ls.NewColumn();
            ls.ColumnWidth = canvas.width - 200f;
            Text.Font = GameFont.Small;
            ls.Gap(60f);
            ls.CheckboxLabeled("SettingsFilthLabel".Translate(), ref settings.filthTweakEnabled, 0f);
            Text.Anchor = (TextAnchor)0;
            ls.End();
